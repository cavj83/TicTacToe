...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../../css/fontawesome.5.15.4/css/all.css">
    </head>
    <body>
        <div class="input-group">
            <a role="button" class="btn btn-outline-primary" href="../../index.html">
            <i class="fas fa-play fa-rotate-180"></i> Regresar</a>
            <span class="input-group-text">SUDOKU!!</span>
        </div>

        <div class="row">
            <div class="col">
                <div class="input-group">
                    <button class="btn btn-outline-secondary" type="button" onclick="location.href='../../index.html';">
                    <i class="fas fa-play fa-rotate-180"></i> Regresar</button>
                    <span class="input-group-text">SUDOKU!!</span>
                </div>
            </div>
        </div>
